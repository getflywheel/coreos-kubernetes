...
var (
	cmdRenderConfig = &cobra.Command{
		Use:          "renderConfig",
		Short:        "Render a CloudFormation template without TLS Generation",
		Long:         ``,
		RunE:         runCmdRenderConfig,
		SilenceUsage: true,
	}
)

func init() {
	cmdRoot.AddCommand(cmdRenderConfig)
}

func runCmdRenderConfig(cmd *cobra.Command, args []string) error {
